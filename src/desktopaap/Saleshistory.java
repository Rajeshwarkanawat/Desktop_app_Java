...
ResultSet rs;
    ...
    public ArrayList<User1> userList(){
       ...
       try{ Connection con = DBConnection.getConn();
                ...
                User1 users;
                while(rs.next()){
                    users=new User1(rs.getInt("id"),rs.getString("item"),rs.getString("cnm"),rs.getString("city"),rs.getInt("qty"),rs.getInt("salesprice"),rs.getInt("total"));
                    usersList.add(users);
                }
        }catch(Exception ee){
    ...
    private void initComponents() {
        ...
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(268, 12, -1, 36));
        ...
        table.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Item", "Company.nm", "City", "Quantity", "Sales price", "Total"
            }
        ) {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(92, 84, 559, 317));
        ...
        getContentPane().add(home, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 20, 104, 36));
